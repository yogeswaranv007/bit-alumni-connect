...
/**
 * Payload for updating non-identity profile information.
 * Protected academic fields (roll number, register number, department, degree, batch)
 * cannot be altered by alumni without administrative oversight.
 */
